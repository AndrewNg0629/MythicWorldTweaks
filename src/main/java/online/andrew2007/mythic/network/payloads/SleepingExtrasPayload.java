...
public record SleepingExtrasPayload(Unit unit) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SleepingExtrasPayload> CODEC = PacketCodec.tuple(MythicNetwork.UNIT_CODEC, SleepingExtrasPayload::unit, SleepingExtrasPayload::new);
