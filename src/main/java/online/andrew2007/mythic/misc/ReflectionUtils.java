...
public class ReflectionUtils {
    ...
    public static final ReflectedField<TridentEntity, Boolean> TridentEntity$dealtDamage = new ReflectedField<>(TridentEntity.class, Boolean.class, "dealtDamage", "field_7648");
