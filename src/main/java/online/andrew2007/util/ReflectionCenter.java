...
public class ReflectionCenter {
    ...
    public static <C, F> F getFieldValue(FieldContainer<C, F> fieldContainer, C instance) {
        try {
            Object value = fieldContainer.getField().get(instance);
            Class<F> fieldType = fieldContainer.getFieldType();
            return fieldType.cast(value);
        } catch (IllegalAccessException | ClassCastException e) {
            throw new RuntimeException(String.format("Failed to get value of field: %s", fieldContainer.getField()), e);
        }
    }

    public static <C, F> void setFieldValue(FieldContainer<C, F> fieldContainer, C instance, F targetValue) {
        try {
            fieldContainer.getField().set(instance, targetValue);
        } catch (IllegalAccessException | IllegalArgumentException e) {
            throw new RuntimeException(String.format("Failed to set value of field: %s", fieldContainer.getField()), e);
        }
    }
