...
import top.aenp.mwt.config.patterns.BinaryToggleTweaksConfig;
import top.aenp.mwt.config.patterns.ItemEditorConfig;
import top.aenp.mwt.config.patterns.ModConfig;
import top.aenp.mwt.config.patterns.ParamsRequiredTweaksConfig;
import top.aenp.mwt.config.runtimeParams.LocalRuntimeParams;
import top.aenp.mwt.config.runtimeParams.TransmittableRuntimeParams;
import top.aenp.mwt.item.ItemEditor;
import top.aenp.mwt.misc.LocalToaster;
import top.aenp.mwt.misc.WardenEntityStuff;
import top.aenp.mwt.network.payloads.PlayConfigPushPayload;
    ...
    public static synchronized void loadTransmittableParamsFromConfig(boolean isStartup) {
        ...
        if (modConfig.tweaksEnabled() && localRuntimeParams.modEnabled()) {
            ...
            newParams = new TransmittableRuntimeParams(
                    ...
                    binaryToggleTweaksConfig.goldTrimsCalmPiglins(),
